...
class Lista:
    ...
    def gastosSueldoPorEmpleado(self, cuil):
        bandera = True
        cabeza = self.__comienzo
        while cabeza is not None and bandera:
            dato = cabeza.getDato()
            if dato.getCuil() == cuil:
                print("Nombre: {} -- Sueldo: {}".format(dato.getNombre(), dato.getSueldo()))
                bandera = False
    ...
    def modificarPorcentajeporcargo(self, cuil, nuevoporcentaje):
        ...
        while cabeza is not None and bandera:
            dato = cabeza.getDato()
            if dato.getCuil() == cuil:
                dato.setPorcentaje(nuevoporcentaje)
                print("Modificacion Exitosa")
                bandera = False
    ...
    def modificarImporteExtra(self, cuil, nuevoImporteExtra):
        ...
        while cabeza is not None and bandera:
            dato = cabeza.getDato()
            if dato.getCuil() == cuil:
                dato.setimporteExtra(nuevoImporteExtra)
                print("Modificacion Exitosa")
                bandera = False
